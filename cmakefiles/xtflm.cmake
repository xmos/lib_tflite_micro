...
list(APPEND TFLITE_SOURCES  "${TFLITE_SRC_DIR}/kernels/internal/common.cc")
list(APPEND TFLITE_SOURCES  "${TFLITE_SRC_DIR}/kernels/internal/reference/comparisons.cc")
list(APPEND TFLITE_SOURCES  "${TFLITE_SRC_DIR}/kernels/internal/quantization_util.cc")
list(APPEND TFLITE_SOURCES  "${TFLITE_SRC_DIR}/kernels/internal/portable_tensor_utils.cc")
list(APPEND TFLITE_SOURCES  "${TFLITE_SRC_DIR}/kernels/internal/tensor_ctypes.cc")
list(APPEND TFLITE_SOURCES  "${TFLITE_SRC_DIR}/schema/schema_utils.cc")
list(APPEND TFLITE_SOURCES  "${TFLITE_SRC_DIR}/micro/micro_log.cc")
...
list(APPEND XTFLIB_XCORE_SOURCES "${XTFLIB_SRC_DIR}/../fast_flash_read_loop.S")
list(APPEND XTFLIB_XCORE_SOURCES "${XTFLIB_SRC_DIR}/../fast_flash_read_loop.vx.S")
list(APPEND XTFLIB_XCORE_SOURCES "${XTFLIB_SRC_DIR}/../fast_flash.c")
list(APPEND XTFLIB_XCORE_SOURCES "${XTFLIB_SRC_DIR}/../flash_server.c")
list(APPEND XTFLIB_XCORE_SOURCES "${XTFLIB_SRC_DIR}/../load_weights.c")
list(APPEND XTFLIB_XCORE_SOURCES "${XTFLIB_SRC_DIR}/../ioserver.c")
list(APPEND XTFLIB_XCORE_SOURCES "${XTFLIB_SRC_DIR}/../memory_parallel_transport.c")
list(APPEND XTFLIB_XCORE_SOURCES "${XTFLIB_SRC_DIR}/../memory_transport_ll.S")
...
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_add.cc")
...
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_maxpool2d.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_detection_post.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_load_weights_wait.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_load_store_tensor.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_lookup.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_softmax.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_batch_matmul.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_batched_softmax.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_slice.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_broadcast.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_pad.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_concat.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_transpose.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_n_to_4.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_mul.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_mean.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_meani16.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_expand_8_to_16.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_binaryi16.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_unaryi16.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_beta_activationf32.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_beta_concatf32.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_beta_convf32.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_beta_transposeconvf32.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_beta_fcf32.cc")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/conv2d_float.c")
list(APPEND XTFLIB_KERNEL_SOURCES  "${XTFLIB_SRC_DIR}/xcore_utils.cc")

list(APPEND TFLM_SOURCES  "${TFLITE_SRC_DIR}/array.cc")
...
list(APPEND TFLM_SOURCES  "${TFLM_SRC_DIR}/micro_interpreter_context.cc")
list(APPEND TFLM_SOURCES  "${TFLM_SRC_DIR}/micro_interpreter_graph.cc")
...
list(APPEND TFLM_SOURCES  "${TFLM_SRC_DIR}/memory_planner/linear_memory_planner.cc")
...
list(APPEND TFLM_KERNEL_SOURCES  "${TFLM_SRC_DIR}/tflite_bridge/micro_error_reporter.cc")
list(APPEND TFLM_KERNEL_SOURCES  "${TFLM_SRC_DIR}/tflite_bridge/flatbuffer_conversions_bridge.cc")
...
list(APPEND TFLM_KERNEL_SOURCES  "${TFLM_SRC_DIR}/kernels/batch_matmul.cc")
...
list(APPEND TFLM_KERNEL_SOURCES  "${TFLM_SRC_DIR}/kernels/reshape_common.cc")
...
list(APPEND TFLM_KERNEL_SOURCES  "${TFLM_SRC_DIR}/kernels/select.cc")
...
list(APPEND TFLM_KERNEL_SOURCES  "${TFLM_SRC_DIR}/kernels/squared_difference.cc")
...
list(APPEND TFLM_KERNEL_SOURCES  "${TFLM_SRC_DIR}/kernels/strided_slice_common.cc")
