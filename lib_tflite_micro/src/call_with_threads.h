...
/** Function that creates threads, then calls a function, then destroys threads
 * This function creates four threads.
 *
 * \param   f      Function to be called when threads are created
 * \param   ptr    Poitner to a thread_info block. The thread-ids will 
 ...
 */
void call_with_threads_4_(function_pointer f, thread_info_t *ptr);

/** Function that sets up one of the client threads
 * This particular passes three arguments to the thread
 * The thread function will be called with the three arguments.
...
/** Function that starts all thread functions until completion.
 ...
 */
void thread_function_call(void *arg0, void *arg1, void *arg2,
