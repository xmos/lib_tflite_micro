...
const ALIGN(4) float tensor_data2[1] = {
    -0.10025534778833389,
};
const TfArray<1, int> tensor_dimension2 = {1, {1}};
const ALIGN(8) float tensor_data3[1 * 6] = {
    -0.67682290077209473, 0.54124373197555542,  1.032249927520752,
    -0.26129794120788574, -0.64947265386581421, 0.76698356866836548,
};
...
const ALIGN(8) float tensor_data16[24] = {
...
const ALIGN(8) float tensor_data22[24] = {
    0.81149637699127197,
    0.68789982795715332,
    0.50034081935882568,
    -0.33782359957695007,
...
const ALIGN(8) float tensor_data35[24 * 1] = {
    -0.78892803192138672,  -0.066408462822437286, 0.35161417722702026,
    0.82873892784118652,   0.80997800827026367,   -0.64194154739379883,
    0.48032155632972717,   0.26661530137062073,   -0.12920093536376953,
    -0.046929717063903809, -0.45629832148551941,  -0.15663215517997742,
    -0.85566461086273193,  0.7620043158531189,    0.75519061088562012,
    0.14026883244514465,   -0.34299778938293457,  0.1274896115064621,
    -0.77789837121963501,  0.52178329229354858,   0.52061921358108521,
    0.43844866752624512,   0.42333868145942688,   -0.5325203537940979,
};
...
const ALIGN(8) float tensor_data39[24 * 6] = {
    -0.022579669952392578,  0.043456412851810455,   0.30239257216453552,
    -0.20567117631435394,   -0.074365966022014618,  -0.092949599027633667,
    0.00019303386216051877, -0.0035804288927465677, 0.17888210713863373,
    0.13906814157962799,    -0.13194261491298676,   -0.29369610548019409,
    -0.08762822300195694,   0.0013085408136248589,  -0.40365827083587646,
    -0.022184055298566818,  0.014901737682521343,   -0.21936503052711487,
    0.16428762674331665,    0.072828143835067749,   0.2114323228597641,
    -0.25273096561431885,   -0.21754516661167145,   0.097414277493953705,
    0.38464519381523132,    0.18493148684501648,    0.20381182432174683,
    -0.14378896355628967,   -0.20844249427318573,   0.18730002641677856,
    0.14259083569049835,    -0.047009404748678207,  0.14904215931892395,
    -0.060763522982597351,  -0.16218960285186768,   0.13128620386123657,
    -0.1546204537153244,    -0.059371381998062134,  0.19501221179962158,
    -0.10580887645483017,   -0.23217323422431946,   -0.22936071455478668,
    -0.0021029131021350622, 0.064688146114349365,   0.03878474235534668,
    0.22142297029495239,    -0.16029603779315948,   -0.3753601610660553,
    -0.32715627551078796,   0.13923661410808563,    -0.070977889001369476,
    -0.032542452216148376,  0.014878313988447189,   0.40545779466629028,
    -0.060356121510267258,  0.25173348188400269,    0.11893317848443985,
    0.1443747878074646,     0.0079025859013199806,  0.01033000648021698,
    0.3641963005065918,     -0.50888949632644653,   -0.039992153644561768,
    -0.092163838446140289,  -0.061423711478710175,  0.14505985379219055,
    -0.15009048581123352,   0.086118385195732117,   0.33083158731460571,
    -0.42140620946884155,   0.48624292016029358,    0.039929948747158051,
    0.090693637728691101,   -0.01283695176243782,   0.17024977505207062,
    -0.22920811176300049,   0.15299870073795319,    -0.31904631853103638,
    0.12285808473825455,    0.065751530230045319,   0.091771945357322693,
    0.11162638664245605,    -0.073564663529396057,  -0.065775707364082336,
    0.33217611908912659,    0.41962692141532898,    -0.10504135489463806,
    -0.07918558269739151,   0.023805687204003334,   -0.062702901661396027,
    -0.055794805288314819,  0.1239912211894989,     0.1370149701833725,
    0.46396678686141968,    -0.064550302922725677,  -0.02640213631093502,
    -0.073347911238670349,  -0.059045586735010147,  -0.11495655030012131,
    0.040152005851268768,   -0.12168806046247482,   0.095367684960365295,
    0.074778921902179718,   0.056080017238855362,   0.13821674883365631,
    -0.1471501886844635,    -0.23102031648159027,   -0.20438291132450104,
    -0.14502057433128357,   0.1057831272482872,     -0.14780488610267639,
    -0.16759186983108521,   0.24482570588588715,    -0.38713780045509338,
    -0.37223842740058899,   0.11535821110010147,    -0.16456326842308044,
    -0.30136668682098389,   -0.45508956909179688,   0.17768050730228424,
    -0.15122713148593903,   -0.48300850391387939,   -0.018385179340839386,
    -0.16502243280410767,   -0.25257453322410583,   -0.223208948969841,
    0.18494662642478943,    0.31131488084793091,    -0.44953763484954834,
    -0.28992098569869995,   -0.20313996076583862,   -0.14405348896980286,
    -0.21683275699615479,   -0.066648311913013458,  0.00025516003370285034,
    -0.18808770179748535,   0.07135278731584549,    0.017622401937842369,
    0.30879741907119751,    -0.19441895186901093,   -0.29071500897407532,
    -0.077798321843147278,  0.24645853042602539,    0.024298662319779396,
};
...
const TfLiteFullyConnectedParams opdata22 = {
    kTfLiteActNone, kTfLiteFullyConnectedWeightsFormatDefault, false, false};
...
const TensorInfo_t tensorData[] = {
    ...
    },
    {
        kTfLiteFloat32,
        (void*)tensor_data26,
        (TfLiteIntArray*)&tensor_dimension26,
        4,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 96,
        (TfLiteIntArray*)&tensor_dimension27,
        24,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 64,
        (TfLiteIntArray*)&tensor_dimension28,
        24,
    },
    {
        kTfLiteFloat32,
        (void*)tensor_data29,
        (TfLiteIntArray*)&tensor_dimension29,
        4,
    },
    {
        kTfLiteFloat32,
        (void*)tensor_data30,
        (TfLiteIntArray*)&tensor_dimension30,
        4,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 64,
        (TfLiteIntArray*)&tensor_dimension31,
        24,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 0,
        (TfLiteIntArray*)&tensor_dimension32,
        24,
    },
    {
        kTfLiteFloat32,
        (void*)tensor_data33,
        (TfLiteIntArray*)&tensor_dimension33,
        4,
    },
    {
        kTfLiteFloat32,
        (void*)tensor_data34,
        (TfLiteIntArray*)&tensor_dimension34,
        4,
    },
    {
        kTfLiteFloat32,
        (void*)tensor_data35,
        (TfLiteIntArray*)&tensor_dimension35,
        96,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 32,
        (TfLiteIntArray*)&tensor_dimension36,
        24,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 0,
        (TfLiteIntArray*)&tensor_dimension37,
        24,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 0,
        (TfLiteIntArray*)&tensor_dimension38,
        24,
    },
    {
        kTfLiteFloat32,
        (void*)tensor_data39,
        (TfLiteIntArray*)&tensor_dimension39,
        576,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 192,
        (TfLiteIntArray*)&tensor_dimension40,
        24,
    },
    {
        kTfLiteInt32,
        (void*)tensor_data41,
        (TfLiteIntArray*)&tensor_dimension41,
        4,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 64,
        (TfLiteIntArray*)&tensor_dimension42,
        24,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 32,
        (TfLiteIntArray*)&tensor_dimension43,
        24,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 0,
        (TfLiteIntArray*)&tensor_dimension44,
        24,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 0,
        (TfLiteIntArray*)&tensor_dimension45,
        4,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 288,
        (TfLiteIntArray*)&tensor_dimension46,
        24,
    },
    {
        kTfLiteFloat32,
        tensor_arena + 0,
        (TfLiteIntArray*)&tensor_dimension47,
        24,
    },
};
const NodeInfo_t nodeData[] = {
    ...
    {
        (TfLiteIntArray*)&inputs12,
        (TfLiteIntArray*)&outputs12,
        nullptr,
        OP_MINIMUM,
    },
    {
        (TfLiteIntArray*)&inputs13,
        (TfLiteIntArray*)&outputs13,
        nullptr,
        OP_MINIMUM,
    },
    {
        (TfLiteIntArray*)&inputs14,
        (TfLiteIntArray*)&outputs14,
        nullptr,
        OP_MINIMUM,
    },
    {
        (TfLiteIntArray*)&inputs15,
        (TfLiteIntArray*)&outputs15,
        nullptr,
        OP_MAXIMUM,
    },
    {
        (TfLiteIntArray*)&inputs16,
        (TfLiteIntArray*)&outputs16,
        nullptr,
        OP_MAXIMUM,
    },
    {
        (TfLiteIntArray*)&inputs17,
        (TfLiteIntArray*)&outputs17,
        nullptr,
        OP_MAXIMUM,
    },
    {
        (TfLiteIntArray*)&inputs18,
        (TfLiteIntArray*)&outputs18,
        const_cast<void*>(static_cast<const void*>(&opdata18)),
        OP_MUL,
    },
    {
        (TfLiteIntArray*)&inputs19,
        (TfLiteIntArray*)&outputs19,
        const_cast<void*>(static_cast<const void*>(&opdata19)),
        OP_MUL,
    },
    {
        (TfLiteIntArray*)&inputs20,
        (TfLiteIntArray*)&outputs20,
        const_cast<void*>(static_cast<const void*>(&opdata20)),
        OP_ADD,
    },
    {
        (TfLiteIntArray*)&inputs21,
        (TfLiteIntArray*)&outputs21,
        const_cast<void*>(static_cast<const void*>(&opdata21)),
        OP_MUL,
    },
    {
        (TfLiteIntArray*)&inputs22,
        (TfLiteIntArray*)&outputs22,
        const_cast<void*>(static_cast<const void*>(&opdata22)),
        OP_FULLY_CONNECTED,
    },
};
