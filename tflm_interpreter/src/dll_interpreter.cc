...
size_t get_tensor_details_buffer_sizes(inference_engine *ie,
  ...
  return ie->tflm->interpreter->GetTensorDetailsBufferSizes(
...
int get_tensor_details(inference_engine *ie, size_t tensor_index, char *name,
                       ...
                       int *zero_point) {
  return ie->tflm->interpreter->GetTensorDetails(
...
int set_tensor(inference_engine *ie, size_t tensor_index, const void *value,
  ...
  return ie->tflm->interpreter->SetTensor(tensor_index, value, size, shape,
                                          type);
}

int get_tensor(inference_engine *ie, size_t tensor_index, void *value,
               const int size, const int *shape, const int type) {
  return ie->tflm->interpreter->GetTensor(tensor_index, value, size, shape,
                                          type);
}
...
int get_operator_details(inference_engine *ie, size_t operator_index,
                         ...
                         int *outputs) {
  return ie->tflm->interpreter->GetOperatorDetails(
